                ...
                <div class="col pl-5">
                    <div class="card" style="width:450px">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-secondary">Click here to view My Portfolio and My Networth.</p>
                            <a href="#" class="btn btn-warning btn-lg">View Networth</a>
                        </div>
                    </div>
                ...
                <div class="col pl-5">
                    <div class="card" style="width:450px">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-success btn-lg">Sell Asset</a>
                        </div>
                    </div>
